...
(Get-Content ./setup.py).replace('Configuration API lets you effortlessly roll out configuration and execute orchestration between APIs.  # noqa: E501', '') | Set-Content ./setup.py
